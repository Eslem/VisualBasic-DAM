    ...
    Private Sub BindToArray()
        ...
        Try
            With lstProcessesDataSource
                .ValueMember = "Módulo Principal"
                .DisplayMember = "Nombre del proceso"
...
#Region " Code for ComboBox tab "
    ...
    Private Sub BindToDataSet()
        Try
            LoadData()
            cboDemo.DataSource = Me.EmpleadosDataSet.Empleados
            cboDemo.DisplayMember = "Nombre"
            cboDemo.ValueMember = "DNI"
            lblResults.Text = ""
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.OKOnly, Me.Text)
        End Try
    ...
    Private Sub LoadData()
        ...
        statusForm.Show("Conectando con la BD")
...
#Region " Code for BindingSource "
    ...
    Private Function GetCustomerList() As System.ComponentModel.BindingList(Of Customer)
        ...
        newCustomer.Id = 6
        newCustomer.Name = "David Perez Gomez"
