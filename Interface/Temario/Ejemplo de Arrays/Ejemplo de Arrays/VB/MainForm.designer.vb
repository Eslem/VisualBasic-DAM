Partial Public Class MainForm
    ...
    <System.Diagnostics.DebuggerNonUserCode()> Private Sub InitializeComponent()
        ...
        Me.lblNumElements.Text = "Num  &Elementos del Vector dinámico"
        '
        'lblSearchFor
        '
        ...
        Me.lblDataAfter.Text = "No información mostrada"
        '
        'lblDataAsLoaded
        '
        ...
        Me.lblDataAsLoaded.Text = "Información cargada"
        '
        'grpCompareField
        '
        ...
        Me.grpCompareField.Text = "Ca&mpo usado para ordenar"
        '
        'optName
        '
        ...
        Me.optName.Text = "Nombre del cliente"
        '
        'optId
        '
        ...
        Me.grpArrayType.Text = "&Vector de . . ."
        '
        'optObjects
        '
        ...
        Me.cmdCreateMatrix.Text = "Cear una &Matriz"
        '
        'cmdBinarySearch
        '
        ...
        Me.cmdBinarySearch.Text = "&Búsqueda binaria"
        '
        'cmdReverse
        '
        ...
        Me.cmdReverse.Text = "&Dar la vuelta"
        '
        'cmdSort
        '
        ...
        Me.cmdCreateDynamic.Text = "Crear un vector &dinámico"
        '
        'cmdCreateStatic
        '
        ...
        Me.cmdCreateStatic.Text = "&Crear un vector estático"
        '
        'MenuStrip1
        '
        ...
        Me.Name = "MainForm"
        Me.Text = "Trabajando con Vectores"
