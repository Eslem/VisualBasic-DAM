...
Public Class MainForm
    ...
    Private Sub cmdBinarySearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdBinarySearch.Click
        ...
        If Me.optValues.Checked OrElse Me.optId.Checked Then
            ...
            Catch ex As Exception
                MessageBox.Show("Por favor, introduzca un entero a buscar.", "Búsqueda binaria", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        ...
        Else
            ...
            If Me.txtBSearchFor.Text.Length = 0 Then
                MessageBox.Show("Por favor, introduzca un valor a buscar.", "Búsqueda binaria", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Me.txtBSearchFor.Select()
                Exit Sub
            End If
        ...
        If Me.optValues.Checked Then
            ...
            If position >= 0 Then
                message = String.Format("El valor {0} se encontró en el vector en la posición {1}.", valueToFind, position.ToString())
            Else
                ...
                message = String.Format("El valor {0} NO se encontró en el vector. Si existió, estuvo en la posición {1}.", valueToFind, intBWC)
            End If
        Else
            ...
            If position >= 0 Then
                message = String.Format("El valor {0} se encontró en el vector en la posición {1}.", stringToFind, position.ToString())
            Else
                Dim intBWC As Integer = (Not position)
                message = String.Format("El valor {0} NO se encontró en el vector. Si existió, estuvo en la posición {1}.", stringToFind, intBWC)
            End If

        End If

        MessageBox.Show(message, "Resultados de la búsqueda binaria", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
    ...
    Private Sub cmdCreateDynamic_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCreateDynamic.Click
        ...
        If Me.optValues.Checked Then
            ...
            For i = 0 To dynamicValueData.Length - 1
                Try
                    dynamicValueData(i) = CType(InputBox("Introduzca un número", i.ToString(), "Ninguno " & i), Integer)
                Catch
        ...
        Else
            ...
            For i = 0 To dynamicObjectData.Length - 1
                ...
                dynamicObjectData(i).Name = InputBox("Introduzca una cadena", ("Elemento " & (i + 1)), ("Ninguna " & i + 1))
            Next
    ...
    Private Sub cmdReverse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdReverse.Click
        ...
        Me.lblDataAfter.Text = "Información tras darle la vuelta"
        If Me.optValues.Checked Then
            Dim valueArray() As Integer = MakeValueArray()
    ...
    Private Sub cmdSort_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSort.Click
        ...
        Me.lblDataAfter.Text = "Información tras ordenarla"
    ...
    Private Sub CompareKeyCheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        ...
        lblDataAfter.Text = "No hay información que mostrar"
    End Sub
    ...
    Private Sub DisplayArrayData(ByVal arr As Array, ByVal ListBox As WhichListBox)
        ...
        Select Case arr.Rank
            ...
            Case Else
                ...
                lst.Items.Add(String.Format("El vector recibió demasiadas dimensiones ({0})", arr.Rank))
    ...
    Private Function MakeObjectArray() As Customer()
        ...
        Dim names() As String = {"Xavi Castillo", "Gigi Mathew", "Amy Rusko", "Pedro Gutierrez", "Kok-Ho Loh"}
