...
Public Class Customer
    ...
    Public Function CompareTo(ByVal obj As Object) As Integer Implements System.IComparable.CompareTo
        ...
        If TypeOf obj Is Customer Then
            ...
            End If
        Else
            Throw New ArgumentException("Los clientes solo pueden compararse entre si. El objeto pasado fue un " & obj.GetType.ToString())
        End If
    End Function
    ...
    Public Overrides Function ToString() As String
        ...
        Return String.Format("Id={0}, Nombre={1}", Me.Id, Me.Name)
    End Function
End Class
