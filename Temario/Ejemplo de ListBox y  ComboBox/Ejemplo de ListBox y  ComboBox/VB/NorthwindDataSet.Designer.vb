...
Namespace NorthwindDataSetTableAdapters
    ...
    Partial Public Class EmployeesTableAdapter
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_PhotoPath As String,  _
                    ByVal Original_rowguid As System.Guid) As Integer
            Return Me.Update(LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, _Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath, rowguid, Original_EmployeeID, Original_LastName, Original_FirstName, Original_Title, Original_TitleOfCourtesy, Original_BirthDate, Original_HireDate, Original_Address, Original_City, Original_Region, Original_PostalCode, Original_Country, Original_HomePhone, Original_Extension, Original_ReportsTo, Original_PhotoPath, Original_rowguid, Original_EmployeeID)
        End Function
    End Class
End Namespace
